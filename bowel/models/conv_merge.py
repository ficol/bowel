...
from tensorflow.keras.layers import (Conv2D, Conv1D, Dense, Input, MaxPooling2D, BatchNormalization,
                                     TimeDistributed, Dropout, Flatten)
...
class ConvMerge(Model):
    ...
    def build_model(self):
        ...
        model.add(Conv1D(100, kernel_size=9,
