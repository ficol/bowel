...
from tensorflow.keras.layers import (Conv2D, Dense, Bidirectional, GRU, TimeDistributed, Dropout, Flatten)
...
class CRNN(Model):
    ...
    def build_model(self):
        model = Sequential()
        model.add(TimeDistributed(Conv2D(30, kernel_size=(3,3), activation='relu'), input_shape=self.input_dim))
        model.add(TimeDistributed(Conv2D(60, kernel_size=(4,2), activation='relu')))
